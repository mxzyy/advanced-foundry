...
import {ETHStablecoin} from "./Coin.sol";
 ...
 * @title DSCEngine
 * @author mxzyy
 * @notice This contract is the core of the Decentralized Stablecoin system. It handles all the
 * logic for minting and redeeming DSC, as well as depositing and withdrawing collateral.
 *
 ...
 *
 * The system should always be "overcollateralized". At no point should the value of all collateral
 * be less than or equal to the dollar backed value of all the DSC.
 *
...
contract DSCEngine is ReentrancyGuard {
    ...
    ETHStablecoin private immutable i_dsc;
    ...
    constructor(address[] memory tokenAddresses, address[] memory priceFeedAddresses, address dscAddress) {
        ...
        i_dsc = ETHStablecoin(dscAddress);
    }
     ...
     * @param amountCollateral The amount of collateral to redeem
     * @notice Health factor must remain above 1 after withdrawal
     */
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); // likely never hit
    }

    /**
     * @param collateral The ERC-20 collateral address to liquidate from the user
    ...
    function getTokenAmountFromUsd(address token, uint256 usdAmountInWei) public view returns (uint256) {
        ...
        // ($10e18 * 1e18) / ($2000e8 * 1e10) = 0.005e18
    ...
    function getUsdValue(address token, uint256 amount) public view returns (uint256) {
        ...
        // (2000e8 * 1e10) * 1000e18 / 1e18 = $2000000e18
